...
class Tunnel extends GlobalMethods{
    ...
    public function toGetVariation(){
        return $this->product->getVariation();
    }
    ...
    public function toDeleteUserCart($id) {
        return $this->product->deleteUserCart($id);
    }


    public function toGetUser($id){
        return $this->login->getUser($id);
    }
